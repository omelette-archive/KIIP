...
// 2026-08-31 uncertain(139개) 재검토: "고양시농업기술센터"·"남해마늘연구소"처럼 지역명이
// 들어간 공공 농업기관이 원래 목록에 없어 놓치고 있었다("연구소"·"기술센터" 추가). 다만
// "한국임업진흥원"처럼 전국 단위 기관(서울 본사 주소가 실제 산지가 아님)은 여전히 걸러야
// 하므로 "진흥원"은 넣지 않는다 — 지역 연계 여부를 이름으로 구분할 수 없는 전국 기관이다.
