...
function dashboardClient(snapshot, geometry, registrationExamples) {
  ...
  function applicationsScreen() {
    ...
    return `<section class="screen-section coverage-screen"><p class="screen-note">전국 17개 시도의 상표 출원·등록·추이를 한눈에 비교합니다. 특정 지역·품목을 자세히 보려면 <b>지역 상세</b> 탭으로 이동하세요.</p>
