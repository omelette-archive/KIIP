...
function dashboardClient(snapshot, geometry) {
  ...
  function summaryScreen() {
    ...
    <div class="method-note matching-rule"><strong>매칭·집계 기준</strong><p>화면명은 지역의 대표 특산품(예: 사과), 검색·집계 키는 특허청 고시명칭 + NICE류(예: 신선한 사과 · 31류)입니다. 상표명은 개별 사례로만 보존합니다.</p><p><b>현재 출처</b> ${esc(sourceLine)}</p></div>
