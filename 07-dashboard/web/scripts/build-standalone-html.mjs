...
<body><main class="shell"><header class="topbar" id="top"><button class="brand brand-button" id="brand-home" type="button" aria-label="지역 특산품-상표 분석·정책지원 플랫폼 홈"><img class="brand-mark" src="${logoMarkDataUri}" alt="KIIP" width="36" height="24"><span><h1>지역 특산품-상표 분석·정책지원 플랫폼</h1></span></button><div class="snapshot-meta"><span class="sample-badge" id="scope-label"></span><span id="generated"></span><button type="button" class="copy-link-button" id="copy-link-button">이 화면 링크 복사</button></div></header><nav class="primary-tabs" id="primary-tabs" aria-label="대시보드 화면"></nav><div id="app"></div><footer><div class="footer-brand"><img class="footer-logo" src="${logoLockupDataUri}" alt="한국지식재산연구원 Korea Institute of Intellectual Property" height="26"><span>지역 특산품-상표 분석·정책지원 플랫폼</span></div><span id="snapshot-id"></span></footer></main>
