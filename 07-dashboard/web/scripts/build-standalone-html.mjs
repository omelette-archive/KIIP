...
<section class="workspace" id="item-view" hidden><aside class="panel"><div class="panel-head"><p class="eyebrow">ITEM INDEX</p><h2>품목별 조회</h2><input id="item-search" class="search" type="search" placeholder="품목 검색" aria-label="품목 검색"></div><div id="items" class="region-list"></div></aside><section class="panel content" id="item-detail"></section></section>
