...
<body><main class="shell"><header class="topbar" id="top"><button class="brand brand-button" id="brand-home" type="button"><span class="brand-mark">K</span><span><strong>지역 브랜드 인사이트</strong><small>특산품 × 상표 근거 대시보드</small></span></button><div class="snapshot-meta"><span class="sample-badge">샘플 데이터</span><span id="generated"></span></div></header><nav class="primary-tabs" id="primary-tabs" aria-label="대시보드 화면"></nav><div id="app"></div><section class="provenance" id="provenance"></section><footer><span id="snapshot-id"></span><span>수치·판정·지도 경계는 출처와 버전을 함께 표시합니다.</span></footer></main>
