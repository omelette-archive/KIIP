...
function specialtyFilingStatus(item: Item, region: Region): { label: string; className: string } {
  ...
  if (value > 0) {
    return { label: `출원 확인 · ${number(value)}건`, className: "filed" };
  }
  if (!region.regionCode) {
    return { label: "구분 정보 없음", className: "pending" };
  }
