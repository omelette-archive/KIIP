...
- "품목"은 반드시 고시명칭(②의 `noticeName`) 기준이다. 상표명·브랜드명을 품목 대신 쓰지
  않는다 — 지역의 대표 특산품(예: "사과")을 보여줘야 할 자리에 특정 상표명(예: "데일리")이
  나오면 안 된다(2026-08-11 실사례, `docs/dashboard-data-contract.md` §3.1 참고).
