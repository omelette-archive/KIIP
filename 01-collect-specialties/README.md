...
| 지역특화작목(농촌진흥청, #117) | 인증 불필요, 2025 성과보고회 보도자료 붙임3 | ✅ 대표 9·집중육성 18·자체육성 42, 총 69개를 공식 지정 범위인 도 단위 특산품 수집원으로 반영 |
...
│   ├── rdaRegionalSpecialtyCrops.js 농촌진흥청 지역특화작목 69개 공식 스냅샷 적재
